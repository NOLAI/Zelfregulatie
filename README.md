...
[De Flora backend](FLoRA/) bestond al voor het co-creatie project en is veel breder inzetbaar. De [srl (self regulated learning) API](https://github.com/NOLAI/srl-api) en het [srl Dashboard](https://github.com/NOLAI/srl-dashboard) zijn voor dit project ontwikkeld.
